    ...
    <>
      ...
      <nav className="bg-gradient-to-r from-indigo-200/20 md:px-0 px-6 text-slate-800 border-slate-900/10 border-b dark:border-slate-300/10 py-2.5 dark:bg-gray-900">
        <div className="max-w-6xl flex flex-wrap justify-between relative items-center mx-auto">
          ...
          <div
            className="md:relative absolute inset-x-0 md:top-0 top-16 bg-gradient-to-r from-indigo-100 to-teal-100 dark:from-indigo-400 dark:to-teal-400 z-50 md:px-0 md:from-transparent md:dark:from-transparent py-4 justify-between items-center w-full md:flex md:w-auto md:order-1 md:space-y-0 space-y-8 hidden"
            id="dropdownMenu"
          >
            ...
            <div className="flex items-center space-x-10 md:border-l  border-slate-200 ml-6 pl-6 dark:border-slate-800">
              ...
              >
                ...
                <span className="hidden dark:inline dark:hover:stroke-slate-300">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    strokeWidth="2"
              ...
              <a
                ...
                className="ml-6 block text-slate-700 hover:text-slate-700 dark:hover:text-slate-300"
              >
                <span className="sr-only">Summa on GitHub</span>
                <svg
                  viewBox="0 0 16 16"
                  className="w-5 h-5"
                  fill="currentColor"
