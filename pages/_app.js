    ...
    <>
      ...
      <nav className="bg-gradient-to-r from-indigo-200/20 md:px-0 px-6 text-slate-800 border-slate-900/10 border-b dark:border-slate-300/10 py-2.5 dark:bg-gray-900">
        <div className="max-w-6xl flex flex-wrap justify-between relative items-center mx-auto">
          ...
          <div
            className="md:relative absolute inset-x-0 md:top-0 top-16 bg-gradient-to-t from-rose-100 via-red-100 to-teal-100 z-50 md:px-0 md:from-transparent py-4 justify-between items-center w-full md:flex md:w-auto md:order-1 md:space-y-0 space-y-8 hidden"
            id="dropdownMenu"
          >
